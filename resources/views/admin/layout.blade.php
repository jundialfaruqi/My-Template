...
<body class="min-h-screen bg-base-200">
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            <!-- Navbar -->
            <div class="px-4 py-2 lg:px-6 lg:pt-3">
                <div class="navbar bg-base-100 border border-base-300 rounded-xl">
                    ...
                    <div class="flex-none flex items-center gap-2">
                        ...
                        <div class="dropdown dropdown-end hidden lg:block">
                            <label tabindex="0"
                                class="btn btn-neutral btn-circle h-10 w-10 flex items-center justify-center">
                                <div class="indicator">
                        ...
                        <div class="card bg-base-100 border border-base-300 rounded-xl">
                            <div class="card-body md:p-6">
                                <div class="card-title">
                                    <h3 class="text-lg md:text-xl font-bold mb-3 md:mb-4">Recent Activities</h3>
                                </div>
                                <div class="overflow-x-auto">
                                    <table class="table table-zebra table-compact text-sm md:text-base">
                                        <thead>
                                            <tr>
                                                <th class="px-2 md:px-4">Name</th>
                                                <th class="px-2 md:px-4 hidden sm:table-cell">Type</th>
                                                <th class="px-2 md:px-4 hidden md:table-cell">Date</th>
                                                <th class="px-2 md:px-4">Status</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="px-2 md:px-4">Video Pengajian Minggu</td>
                                                <td class="px-2 md:px-4 hidden sm:table-cell">Video</td>
                                                <td class="px-2 md:px-4 hidden md:table-cell">2023-10-15</td>
                                                <td class="px-2 md:px-4">
                                                    <div class="badge badge-success badge-sm md:badge-md">Published
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="px-2 md:px-4">Ceramah Ustadz Ahmad</td>
                                                <td class="px-2 md:px-4 hidden sm:table-cell">Video</td>
                                                <td class="px-2 md:px-4 hidden md:table-cell">2023-10-14</td>
                                                <td class="px-2 md:px-4">
                                                    <div class="badge badge-success badge-sm md:badge-md">Published
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="px-2 md:px-4">Kajian Tafsir Al-Quran</td>
                                                <td class="px-2 md:px-4 hidden sm:table-cell">Video</td>
                                                <td class="px-2 md:px-4 hidden md:table-cell">2023-10-12</td>
                                                <td class="px-2 md:px-4">
                                                    <div class="badge badge-warning badge-sm md:badge-md">Draft</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="px-2 md:px-4">Tanya Jawab Seputar Ibadah</td>
                                                <td class="px-2 md:px-4 hidden sm:table-cell">Video</td>
                                                <td class="px-2 md:px-4 hidden md:table-cell">2023-10-10</td>
                                                <td class="px-2 md:px-4">
        ...
        <!-- Sidebar -->
        <div class="drawer-side z-20 lg:ps-6 lg:py-3">
